...
const addTableActividad = (x, actividad, fecha_ini, fecha_fin) => {
    let htmlTags = `<tr id="item_actividad_${x}">
            ...
            <td class="text-center">
                <button type="button" class="btn btn-warning btn-sm" onclick="addFormActividad(${x},'${actividad}', '${fecha_ini}', '${fecha_fin}')" ><i class="fas fa-pencil-alt"></i></button>
...
const addTablePresupuesto = (x, rubro, recurso_municipio, fondo_mixto, ministerio_cultura, ingreso_propio) => {
    let htmlTags = `<tr id="item_presupuesto_${x}">
            ...
            <td class="text-center">
                <button type="button" class="btn btn-warning btn-sm" onclick="addFormPresupuesto(${x}, ${rubro}, ${recurso_municipio}, ${fondo_mixto}, ${ministerio_cultura}, ${ingreso_propio})"><i class="fas fa-pencil-alt"></i></button>
