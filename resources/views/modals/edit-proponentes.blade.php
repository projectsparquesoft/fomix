    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background:#fcd846">
          <h4 class="modal-title">Editar Proponentes  <i class="fas fa-user-plus"></i></h4>
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button id="actualizar"  type="button" class="btn btn-dark">Guardar   <i class="fas fa-save"></i></button>
        </div>
      </div>
    </div>
</div>
