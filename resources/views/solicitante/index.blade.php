...
<div class="container-fluid">
  ...
  <div class="card card" style="background:#EBF5FB">
    <div class="card-header">
      <button type="button"  class="botones" data-toggle="modal" data-target="#modalCreate">Crear Solicitantes <i class="fas fa-user-plus"></i></button>
            <!----Modals-->
